 ...
 */
void 
jint_process_rows(jpeg_compress_info *cinfo) 
{
  
  int mn; /* current mcu in buffer */
  JSAMPLE *mcu_start;  int mcu_delta;
...
void
jint_add_quant_table( jpeg_compress_info *cinfo, 
...
void 
jint_std_quant_tables( jpeg_compress_info *cinfo ) {
...
void 
jint_add_huff_table ( jpeg_compress_info *cinfo,
...
void 
jint_std_huff_tables (jpeg_compress_info *cinfo) 
{
...
void 
jint_calc_huff_tbl(JHUFF_TBL *htblptr)
{
  int i, j;
  int k, lastk, code, si;
